  ...
  <div class="login_box p-5">
    ...
    <form>
      ...
      <div class="text-center">
        <button type="button" class="btn btn-outline-primary btn-lg m-3" id="btnok" style="width: 35%;">登入</button>
        <button type="button" class="btn btn-outline-info btn-lg m-3" id="btnreg" style="width: 35%;">註冊</button>
      </div>
    </form>
  </div>
</body>
