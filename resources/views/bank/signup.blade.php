  ...
  <div class="login_box p-5">
    ...
    <form>
      ...
      <div class="text-center">
        <button type="button" class="btn btn-outline-primary btn-lg m-3" id="btnok" style="width: 35%;">註冊</button>
        <button type="button" class="btn btn-outline-secondary btn-lg m-3" id="btncancel" style="width: 35%;">取消</button>
      </div>
    </form>
